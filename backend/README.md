...
- Utilizar Mailtrap para testar envios em ambiente de densenvolvimento;
...
- Os agendamentos do prestador no dia devem ser armazenados em cashe;
...
- Os agendamentos devem estar disponíveis entre 8h às 18j (Primeiro às 8h, último às 17h);
